...
public class Main_Frame extends javax.swing.JFrame {
    ...
    public static ShopsDAO shopsDAO = null;
    ...
    public Main_Frame() {
        ...
        shopsDAO = (ShopsDAO) context.getBean("customerDAO");
    }
    ...
    public static void error(BeansException e) {
        e.printStackTrace();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {          
            ...
            if (activeId == -1) {
                shopsDAO.append(tName.getText(), tAddress.getText(), tPhone.getText());
            } else {
                shopsDAO.update(tName.getText(), tAddress.getText(), tPhone.getText(), activeId);
                activeId = -1;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        List<Shops> list = shopsDAO.findById(s);
        
        list.forEach((Shops myShops) -> {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            List<Shops> list = shopsDAO.getFilter(tName1.getText(), tAddress1.getText(), tPhone1.getText());
    ...
    public static void updateTable(){
        try {
            ...
            List<Shops> list = shopsDAO.selectAll();
            list.forEach((myShops) -> {
                model.addRow(new Object[]{myShops.getId(), myShops.getName(), myShops.getAddress(), myShops.getPhone()});
            });
        } catch (BeansException e) {
